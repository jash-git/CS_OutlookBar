...
namespace OutlookBar
{
	...
	internal class BandButton : Button
	{
        ...
        {
            Cursor.Current = Cursors.Hand;//×ƒ“Q»¬Êó
        }
        private void OnMouseLeave(object sender, EventArgs e)
        {
            Cursor.Current = Cursors.Default;//“Q»Ø»¬ÊóÓÎ˜Ë
        }
	...
	public class IconPanel : ContentPanel
	{
        ...
        public void AddIcon(string caption, Image image, EventHandler onClickEvent, int Height)
		{
			int index=Controls.Count/2;	// two entries per icon
            PanelIcon panelIcon = new PanelIcon(this, image, index, onClickEvent, index * (Height + image.Height));
            ...
            label.Size = new Size(Size.Width, Height);
